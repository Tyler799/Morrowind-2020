...
The following two are the recommended tree replacers for the Mournhold region. They are well optimized and quite beautiful. You should use both. The "Dead Trees" mod will over-ride some of the ones from Vurt's Mournhold Tree's II, that's normal.
...
* [Ebonheart Dragon Statue Retexture](http://mw.modhistory.com/download-56-13799) - A vanilla friendly dragon statue replacer.
...
* [Connary's Fine Vials](http://www.fullrest.ru/files/connarysfinevials/files) - Optionally, disable the "icons" folder if you prefer the ones from Ultimate Icon Replacer instead. Also: disable `tx_rustedmetal10.dds`, Intelligent Textures has a better version of this.
...
* [Improved Cavern Clutter](https://www.nexusmods.com/morrowind/mods/44321?tab=description) - Get the "WIP Improved Cavern Clutter". You'll want to disable the three wood_weathered and rope_heavy textures after installing.
